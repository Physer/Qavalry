...
module.exports.config = {
    ...
    onPrepare: function (config, capabilities) {
      ...
      /*
      const resultsJsonLocation = path.join(__dirname, '../_output/reports')
    ...
    before: function before() {
        ...
        //TODO: Check why this is added and why we need it
        /**
         * Setup waitForUrl custom command
        ...
        browser.addCommand('waitForUrl', function (value, timeout, revert) {
          ...
          try {
            ...
            let message = 'Url not ready. Actual: ' + url + ' Expected: ' + actual;
